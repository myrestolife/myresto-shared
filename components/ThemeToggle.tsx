...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-3 rounded-lg transition-colors hover:bg-[var(--color-bg-elevated)] text-[var(--color-text-muted)] min-w-[44px] min-h-[44px] flex items-center justify-center"
